...
export default function BackToTop() {
  ...
  return (
    <button
      onClick={scrollToTop}
      className="fixed bottom-8 z-50 bg-slate-800 hover:bg-slate-700 text-white p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 group border border-slate-600"
