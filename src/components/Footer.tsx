      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-gray-900 rounded-lg p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
              ...
              <div>
                ...
                <div className="mb-4">
                  <p className="text-blue-400 font-semibold">ABN: 29 688 075 505</p>
                </div>
                <button className="bg-white text-black px-4 sm:px-6 py-3 sm:py-4 rounded-lg font-semibold hover:bg-gray-200 transition-colors duration-200 flex items-center justify-center gap-2 border border-gray-300 w-full sm:w-auto text-sm sm:text-base min-h-[44px] touch-manipulation">
            ...
            <div className="mt-8 pt-8 border-t border-gray-700">
              <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 w-full lg:w-auto">
                  <div className="bg-white px-3 sm:px-4 py-3 sm:py-4 rounded border border-gray-300 min-h-[44px] flex items-center justify-center">
                    <span className="text-black text-xs sm:text-sm font-semibold">JAS-ANZ G</span>
                  </div>
                  <div className="bg-white px-3 sm:px-4 py-3 sm:py-4 rounded flex items-center gap-2 border border-gray-300 min-h-[44px]">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between pt-8 border-t border-gray-700 gap-6">
            <div className="flex items-center justify-center lg:justify-start space-x-2 sm:space-x-4 lg:space-x-6">
              <a href="#" className="text-gray-400 hover:text-white transition-colors p-3 sm:p-4 min-h-[44px] min-w-[44px] flex items-center justify-center touch-manipulation">
