    ...
    <footer className="bg-black text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-gray-900 rounded-lg p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
              ...
              <div>
                ...
                <div 
                  className="text-lg font-bold text-white mb-4 hover:text-gray-300 transition-colors cursor-pointer block"
                  onClick={() => {
                ...
                <div className="space-y-3">
                  <div 
                    className="text-gray-300 hover:text-white hover:bg-gray-800 transition-all duration-200 cursor-pointer px-3 py-2 rounded-md border border-transparent hover:border-gray-600"
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div 
                    className="text-slate-300 hover:text-white hover:bg-gray-800 transition-all duration-200 cursor-pointer px-3 py-2 rounded-md border border-transparent hover:border-gray-600 font-semibold"
            ...
            <div className="mt-8 pt-8 border-t border-gray-700">
              <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 w-full lg:w-auto">
                  <a href="https://www.jas-anz.org/" target="_blank" rel="noopener noreferrer" className="bg-white px-3 sm:px-4 py-3 sm:py-4 rounded border border-gray-300 min-h-[44px] flex items-center justify-center hover:bg-gray-100 transition-colors cursor-pointer">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between pt-8 border-t border-gray-700 gap-6">
            <div className="flex items-center justify-center lg:justify-start space-x-2 sm:space-x-4 lg:space-x-6">
              <a href="https://www.linkedin.com/company/cmdcybr" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors p-3 sm:p-4 min-h-[44px] min-w-[44px] flex items-center justify-center touch-manipulation">
                <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                </svg>
              </a>
              <a href="https://twitter.com/cmdcybr" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors p-3 sm:p-4 min-h-[44px] min-w-[44px] flex items-center justify-center touch-manipulation">
                <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </a>
              <a href="https://www.facebook.com/cmdcybr" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors p-3 sm:p-4 min-h-[44px] min-w-[44px] flex items-center justify-center touch-manipulation">
                <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a href="https://www.pinterest.com/cmdcybr" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors p-3 sm:p-4 min-h-[44px] min-w-[44px] flex items-center justify-center touch-manipulation">
                <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex flex-col items-center space-y-4 w-full lg:w-auto">
              <div className="flex flex-wrap justify-center gap-2 sm:gap-4 lg:gap-6">
                <a href="#" className="text-gray-400 hover:text-white transition-colors text-xs sm:text-sm whitespace-nowrap py-2 px-3 rounded-md hover:bg-gray-800 touch-manipulation">Privacy Policy</a>
                <a href="#" className="text-gray-400 hover:text-white transition-colors text-xs sm:text-sm whitespace-nowrap py-2 px-3 rounded-md hover:bg-gray-800 touch-manipulation">Terms and Conditions</a>
                <a href="#" className="text-gray-400 hover:text-white transition-colors text-xs sm:text-sm whitespace-nowrap py-2 px-3 rounded-md hover:bg-gray-800 touch-manipulation">Vulnerability Disclosure Policy</a>
                <a href="#" className="text-gray-400 hover:text-white transition-colors text-xs sm:text-sm whitespace-nowrap py-2 px-3 rounded-md hover:bg-gray-800 touch-manipulation">Security Advisories</a>
              </div>
              <p className="text-gray-400 text-xs sm:text-sm text-center lg:text-right">©2025 CMD:CYBR Cybersecurity Pty Limited | ABN: 29 688 075 505</p>
            </div>
          </div>
        </div>
      </div>
