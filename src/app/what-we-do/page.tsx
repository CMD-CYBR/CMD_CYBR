        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg p-8 border border-gray-200 slide-up">
              ...
              <h3 className="text-xl font-bold text-black mb-4">Consulting</h3>
            ...
            <div className="bg-white rounded-lg p-8 border border-gray-200 slide-up">
              ...
              <h3 className="text-xl font-bold text-black mb-4">MDR</h3>
              <p className="text-gray-600 mb-6">
            ...
            <div className="bg-white rounded-lg p-8 border border-gray-200 slide-up">
              ...
              <h3 className="text-xl font-bold text-black mb-4">Incident Response and Digital Forensics</h3>
              <p className="text-gray-600 mb-6">
