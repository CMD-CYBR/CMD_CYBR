          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="slide-in-left">
              ...
              <p className="text-lg text-gray-300 mb-6 leading-relaxed">
                Managed Detection and Response (MDR) is a comprehensive cybersecurity service that combines 
                advanced threat detection technologies with expert human analysis to provide 24/7 monitoring, 
                threat hunting, and rapid incident response capabilities.
              </p>
            ...
            <div className="slide-in-right">
              <div className="bg-white rounded-lg p-8 shadow-lg">
                ...
                <ul className="space-y-3 text-gray-700">
                  ...
                  <li className="flex items-start">
                    <span className="text-green-500 mr-3">✓</span>
                    <span>Expert threat analysis</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-500 mr-3">✓</span>
      ...
      <section className="py-20 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-lg p-8 slide-up">
              <h3 className="text-2xl font-bold text-black mb-4">Advanced Threat Detection</h3>
              <p className="text-gray-600 mb-4">
                We leverage the latest in AI, machine learning, and behavioral analytics to detect 
                sophisticated threats that traditional security tools might miss.
              </p>
              <ul className="space-y-2 text-gray-600">
